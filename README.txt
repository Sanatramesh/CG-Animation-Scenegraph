...
3. Rotation:
	Click and drag left mouse button to rotate the object. The rotations
	happens in all there directions around the objects center.

4. Lighting:
	a.) 1: Disable/Enable Light2, ambient light.
	b.) 2: Disable/Enable Light0, spotlight on Object0.
	c.) 3: Disable/Enable Light1, spotlight on Object1.
	...
	i.) c: change the camera position.
